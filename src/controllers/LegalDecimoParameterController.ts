...
export class LegalDecimoParameterController {
  ...
  async getById(req: Request, res: Response) {
    try {
      ...
      const parameter = await prisma.legalDecimoParameter.findUnique({
        where: { id }
      })
  ...
  async create(req: Request, res: Response) {
    try {
      ...
      const existing = await prisma.legalDecimoParameter.findUnique({
        where: {
          companyId_key: {
            companyId: companyId,
            key: normalizedKey
      ...
      const parameter = await prisma.legalDecimoParameter.create({
        data: {
          key: normalizedKey,
          name,
          type,
  ...
  async update(req: Request, res: Response) {
    try {
      ...
      const updated = await prisma.legalDecimoParameter.update({
        where: { id },
        data: {
          ...(name && { name }),
          ...(type && { type }),
  ...
  async delete(req: Request, res: Response) {
    try {
      ...
      await prisma.legalDecimoParameter.delete({
        where: { id }
      })
  ...
  async getISRRates(req: Request, res: Response) {
    try {
      ...
      const rates = await prisma.legalDecimoParameter.findMany({
        where: {
          companyId: String(companyId),
          category: 'isr',
          status: 'active'
