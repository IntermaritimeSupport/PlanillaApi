            ...
            const newCompany = await prisma.$transaction(async (tx) => {
                ...
                const legalParametersData = [
                    ...
                    },
                    {
                        ...
                        status: 'active',
                        effectiveDate: new Date(),
                        description: 'Cuota patronal de SS (Art. 62 Ley 51/2005)',
                    },
                    {
                        key: 'ss_decimo',
                        name: 'Seguro Social - XIII Mes Empleado',
                        type: 'employee',
                        category: 'social_security',
                        percentage: 7.25,
                        companyId: company.id,
                        status: 'active',
                        effectiveDate: new Date(),
                        description: 'Cuota de SS empleado para el décimo tercer mes',
                    },
                    {
                        key: 'ss_decimo_patrono',
                        name: 'Seguro Social - XIII Mes Patrono',
                        type: 'employer',
                        category: 'social_security',
                        percentage: 10.75,
                        companyId: company.id,
                        status: 'active',
                        effectiveDate: new Date(),
                        description: 'Cuota patronal de SS para el décimo tercer mes',
                    },
                    {
                        key: 'se_empleado',
